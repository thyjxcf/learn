...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
<td width="555" align="center" valign="middle" bgcolor="#F7F6F6">

	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="556" height="453">
      <param name="movie" value="images/map.swf">
      <param name="quality" value="high">
      <embed src="images/map.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="556" height="453"></embed>
    </object>
	</td>
   ...
   <table width="221" border="0" height="520" cellpadding="0" cellspacing="0">
    <tr height="100%">
      <td bgcolor="#FFFFFF">
      <iframe FRAMEBORDER="no" scrolling="no" width="100%" height="100%" name="regionSchIFrame" src="getRecommendSchoolList.action?schoolRegionCode=${schoolRegionCode?default("")}"></iframe>
      </td>
    </tr>
  </table>
  </td>
