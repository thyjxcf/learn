<html>
  ...
  <tr>
	...
	<table width="1%" border="0" cellpadding="3" cellspacing="1" >
          <tr>
            <td width="350" height="232" colspan="3" algin="center"><img id="showpic" src="images/noUploadPic.jpg" width="350" height="232"></td>
          </tr>
    </table>
	</td>
      </tr>
      <form name="form1" action="addRecommendSchool.action" method="post" enctype="multipart/form-data">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="26"><strong>学校名称</strong>：<input id="schoolName" class="input" name="schoolName" size="45" type="text" maxlength="20" value=""> <font color="red">*</font></td>
          </tr>
          <tr>
            <td height="26"><strong>学校主页</strong>：<input class="input" name="schoolHomepage" size="45" type="text" maxlength="20" value=""></td>
          </tr>
          <tr>
            <td height="26"><strong>学校博客</strong>：<input class="input" name="schoolBlog" size="45" type="text" maxlength="20" value=""></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="26"><strong>学校地址</strong>：<input class="input" name="schoolAddress" size="45" type="text" maxlength="30" value=""></td>
          </tr>
          <tr>
            <td height="26"><strong>邮政编码</strong>：<input class="input" name="schoolPostcode" size="45" maxlength="6" onkeyup=" value=value.replace(/[^\d]/g,'') " 
            	onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" value="">
          </tr>
          <tr>
            <td height="26"><strong>区域编码</strong>：<input class="input" name="schoolRegionCode" size="45" type="text" maxlength="6" value=""></td>
          </tr>
          <tr>
            <td height="26"><strong>联系电话</strong>：<input class="input" name="schoolPhone" size="45" type="text" maxlength="20" value=""></td>
          </tr>
          <tr>
            <td height="26"><strong>传　　真</strong>：<input class="input" name="schoolFax" size="45" type="text" maxlength="20" value=""></td>
          </tr>
          <tr>
            <td height="26"><strong>电子邮件</strong>：<input class="input" name="schoolEmail" size="45" type="text" maxlength="20" value=""></td>
          </tr>
          <tr>
            <td height="26"><strong>学校图片</strong>：<input class="input" id="schoolPictureUrl" name="schoolPictureUrl" size="35" type="file" maxlength="20" value="" onchange="showPic()"></td>
          ...
          <tr>
            <td height="30">
            <textarea name="schoolIntroduction" class="input" rows="7" cols="58">
            </textarea></td>
          </tr>
