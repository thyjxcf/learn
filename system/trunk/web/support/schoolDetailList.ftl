...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td height="30"><img src="images/sm_pic2.gif" width="7" height="7" hspace="4"><span style="padding-left:5px">当前位置：首页 &gt;&gt; 学校推荐 &gt;&gt; ${schoolName?default("")}</span></td>
  </tr>
</table>
    ...
    <td align="center" valign="top" bgcolor="#F7F6F6"><br>
      ...
      <tr>
        ...
        <tr>
		  ...
		  <#if tList_index % 2 == 0>
			  <tr id="${tList.schoolId?default("")}" >
			    <td height="23" width="300">·<a href="${request.contextPath}\support\getRecommendSchoolDetail.action?schoolId=${tList.schoolId?default("")}">${tList.schoolName?default("")}</a></td>
			    <td height="23" >${tList.schoolRegionCode?default("")}</td>
			  </tr>
		  <#else>
			  <tr id="${tList.schoolId?default("")}">
	    	  	<td height="23" class="bg_gray" width="300">·<a href="${request.contextPath}\support\getRecommendSchoolDetail.action?schoolId=${tList.schoolId?default("")}">${tList.schoolName?default("")}</a></td>
	    	  	<td height="23" class="bg_gray" >${tList.schoolRegionCode?default("")}</td>
	  		  </tr>
		  </#if>
		 </#list>
      ...
      <tr bgcolor="#F6FCF2">
      	<td colspan="2" align="left" valign="middle" height="30">${htmlOfPagination2}</td>
      </tr>
    </table>
	<br></td>
