...
<div id="container">
    <div class="login-wrap login-wrap-xian">
        <div class="login-inner">
            ...
            <p>单位名称：<span class="tip-unitname"></span></p>
            <p>&nbsp;</p>
...
$(function(){
	...
	$("#uid").blur(function(){
		$(".tip-unitname").html("");
		$.ajax({
			url:"${request.contextPath}/fpf/open/getUnitNameByUserName.action",
			type:"POST",
			dataType:"JSON",
			data:$("form").serialize(),
			success:function(data){
				if(data.success){
					$(".tip-unitname").html(data.unitName);
					$(".tip-unitname").show();
				}
			}
		});
