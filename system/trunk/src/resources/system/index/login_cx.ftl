...
<link rel="stylesheet" type="text/css" href="${request.contextPath}/static/layout-binjiang.css">
</head>
<body class="login">
<div id="header">
	<div class="header-inner">
        <div class="mini-top">
            <p class="logo"><a><img src="${request.contextPath}/static/images/logo_cixi.png" />${platFormName!}</a></p>
        </div>
    </div>
</div>
