...
<script src="${request.contextPath!}/office/mobile/goOut/js/wap.js"></script>
<script src="${request.contextPath!}/office/mobile/goOut/js/wapEntities.js"></script>
<script src="${request.contextPath!}/office/mobile/goOut/js/wapNetwork.js"></script>
<script src="${request.contextPath!}/office/mobile/goOut/js/wapNetworkService.js"></script>
