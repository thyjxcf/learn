...
<script src="${request.contextPath!}/office/mobile/teacherleave/js/wap.js"></script>
<script src="${request.contextPath!}/office/mobile/teacherleave/js/wapEntities.js"></script>
<script src="${request.contextPath!}/office/mobile/teacherleave/js/wapNetwork.js"></script>
<script src="${request.contextPath!}/office/mobile/teacherleave/js/wapNetworkService.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(wap.init(contextPath, unitId, userId, userRealName), 200)
}, false);
</script>
</html>
