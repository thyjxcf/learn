...
<script src="${request.contextPath!}/office/mobile/workreport/js/wap.js"></script>
<script src="${request.contextPath!}/office/mobile/workreport/js/wapEntities.js"></script>
<script src="${request.contextPath!}/office/mobile/workreport/js/wapNetwork.js"></script>
<script src="${request.contextPath!}/office/mobile/workreport/js/wapNetworkService.js"></script>
