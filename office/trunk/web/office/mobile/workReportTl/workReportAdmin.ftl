...
<script src="${request.contextPath!}/office/mobile/workReportTl/js/wap.js"></script>
<script src="${request.contextPath!}/office/mobile/workReportTl/js/wapEntities.js"></script>
<script src="${request.contextPath!}/office/mobile/workReportTl/js/wapNetwork.js"></script>
<script src="${request.contextPath!}/office/mobile/workReportTl/js/wapNetworkService.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
	...
	storage.set(WapConstants.MANAGE_MODE,WapConstants.BOOLEAN_0);
	<#if manager>
		storage.set(WapConstants.MANAGE_MODE,WapConstants.BOOLEAN_1);
	</#if>
