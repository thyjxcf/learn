...
<script src="${request.contextPath!}/office/mobile/evection/js/wap.js"></script>
<script src="${request.contextPath!}/office/mobile/evection/js/wapEntities.js"></script>
<script src="${request.contextPath!}/office/mobile/evection/js/wapNetwork.js"></script>
<script src="${request.contextPath!}/office/mobile/evection/js/wapNetworkService.js"></script>
