...
<script src="${request.contextPath!}/office/mobile/expense/js/wap.js"></script>
<script src="${request.contextPath!}/office/mobile/expense/js/wapEntities.js"></script>
<script src="${request.contextPath!}/office/mobile/expense/js/wapNetwork.js"></script>
<script src="${request.contextPath!}/office/mobile/expense/js/wapNetworkService.js"></script>
