...
$(document).ready(function() {
	...
	load("#msgInboxUserList",contextPath+"/office/msgcenter/msgcenter-listReceivedMessagesUser.action?readType=${readType!}");
...
function searchMsg(type){
  ...
  var url = contextPath + "/office/msgcenter/msgcenter-listReceivedMessagesUser.action?";
...
<div class="msg-dataInfo mt-10">
	<div class="msg-search fn-right fn-clear">
    	<a href="javascript:void(0);" class="abtn-blue abtn-advSearch fn-right ml-5" id="button_gaoji">高级</a>
...
<div class="msg-advSearch" style="display:none;" id="content_gaoji">
	<#if switchName>
	<span class="fn-left mr-10 ml-10">邮件来源：</span>
	<#else>
	<span class="fn-left mr-10 ml-10">消息来源：</span>
	</#if>
	<div class="ui-select-box fn-left mr-10" style="width:100px;">
        <input type="text" class="ui-select-txt" value="" />
        <input type="hidden" value="" id="searchMsgType" name="searchMsgType" class="ui-select-value" />
        <a class="ui-select-close"></a>
        <div class="ui-option" myfunchange="searchMsg(2);">
        	<div class="a-wrap">
                <a val=""><span>请选择</span></a>
