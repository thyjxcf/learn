...
$(document).ready(function() {
	...
	load("#msgInboxOtherList",contextPath+"/office/msgcenter/msgcenter-listReceivedMessagesOther.action?receiveType=${receiveType!}");
...
function searchMsg(type){
  ...
  var url = contextPath + "/office/msgcenter/msgcenter-listReceivedMessagesOther.action?receiveType=${receiveType!}";
