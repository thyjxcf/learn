...
<form name="reportForm" id="reportForm" action="" method="post">
	...
	<input type="hidden" name="officeRepaire.mark" id="mark" value="${officeRepaire.mark!}"/>
    <div class="wrap">
    	<table border="0" cellspacing="0" cellpadding="0" class="table-edit mt-5" style="table-layout:fixed">
            ...
            <tr>
          	...
          	<tr>
            	<th><span class="c-red">*</span>反馈评价：</th>
            	<td colspan="3">
            		<div class="ui-rating">
						<p>
					        <span class="rating-star">
					            <a href="javascript:void(0);" class="star1" mark="1"></a>
					            <a href="javascript:void(0);" class="star2" mark="2"></a>
					            <a href="javascript:void(0);" class="star3" mark="3"></a>
					            <a href="javascript:void(0);" class="star4" mark="4"></a>
					            <a href="javascript:void(0);" class="star5" mark="5"></a>
					        </span>
					        <span class="rating-info">1分</span>
            ...
            <tr>
	        	<th>反馈说明：</th>
            	<td colspan="3">
            		<textarea id="feedback" name="officeRepaire.feedback" msgName="反馈说明" class="area200" maxLength="200" rows="4" cols="69" style="width:320px;">${officeRepaire.feedback!}</textarea>
            	</td>
	        </tr>
        </table>
    </div>
    ...
    <p class="dd">
        <a href="javascript:void(0);" class="abtn-blue" id="saveBtn" onclick="saveFeedback();">保存</a>
...
function saveFeedback(){
	...
	if($(".rating-star").find(".current").attr("mark")==undefined){
		$("#errorType").text("反馈 不能为空！");
		return;
	}else{
		$("#errorType").text("");
		var feedback=$(".rating-star").find(".current").attr("mark");
		$("#mark").val(feedback);
	}
	...
	var options = {
	       url:'${request.contextPath}/office/repaire/repaire-saveFeedback.action', 
	       dataType : 'json',
	       clearForm : false,
	       resetForm : false,
	       type : 'post',
...
$('.rating-star a').click(function(){
	...
	if(feedback=="" || feedback=='非常差' || feedback=='很差' || feedback=='一般' || feedback=='很好' || feedback=='非常好'){
		$("#feedback").val(myText);
	}
});
