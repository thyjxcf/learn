    ...
    <@htmlmacro.tableDetail divClass="table-form">
	    ...
	    <tr>
	    	 <th><span class="c-orange mr-5">*</span>申请人：</th>
		       <td colspan="3">
		        	<input type="text"  class="input-txt fn-left" id="place" readonly="true" name="officeGoOut.applyUserName" maxlength="50" notNull="true" value="${officeGoOut.applyUserName!}" style="width:136px;">
		        </td>
	    </tr>	
	    <tr>
