...
function doSearch(){
	...
	load("#myGoodsListDiv", "${request.contextPath}/office/goodmanage/goodmanage-myGoods2-list.action?searchType="+searchType+"&searchName="+encodeURIComponent(searchName));
}
</script>
