...
<script>
function doEdit(thisId){
	openDiv("#salaryAddLayer", "#salaryAddLayer .close,#salaryAddLayer .submit,#salaryAddLayer .reset", "${request.contextPath}/office/salarymanage/salarymanage-salaryManageEdit.action?salaryId="+thisId, null, null, "1200px");
	//load("#myWorkReportdiv", "${request.contextPath}/office/salarymanage/salarymanage-salaryManageEdit.action?salaryId="+thisId);
}
function doEdit2(thisId){
	openDiv("#salaryAddLayer", "#salaryAddLayer .close,#salaryAddLayer .submit,#salaryAddLayer .reset", "${request.contextPath}/office/salarymanage/salarymanage-salaryImportEdit.action?importId="+thisId, null, null, "1200px");
}
function doEdit1(thisId){
	openDiv("#salaryAddLayer", "#salaryAddLayer .close,#salaryAddLayer .submit,#salaryAddLayer .reset", "${request.contextPath}/office/salarymanage/salarymanage-salarySortEdit.action?sortId="+thisId, null, null, "1200px");
	//load("#myWorkReportdiv", "${request.contextPath}/office/salarymanage/salarymanage-salaryImportEdit.action?importId="+thisId);
}
...
function doDelete(thisId){
	...
	$.getJSON("${request.contextPath}/office/salarymanage/salarymanage-salaryManageDelete.action", 
		{"salaryId":thisId}, function(data){
...
<div class="pub-table-inner" style="margin-top:15px;width:1200px;">
...
<div class="typical-table-wrap pt-15" <#if officeSalaryImport.salary9! !="">style="width:1200px;overflow-x:auto;"</#if>>
	...
	<tr>
		...
		<#else>
			...
			<#if officeSalarySort?exists>
			<th class="t-center" width="100px;" style="word-break:break-all; word-wrap:break-word;"><a href="javascript:doEdit1('${officeSalarySort.id!}');"><img src="${request.contextPath}/static/images/icon/edit.png" alt="编辑"></a></th>
			</#if>
	</tr>
	</#if>
	</#if>
	...
	<tr>
		...
		<th width="13%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.cardnumber!}</th>
		...
		<#elseif officeSalaryImport.salary8?default("")=="">
		<th width="5%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.serialNumbers!}</th>
		<th width="10%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.realname!}</th>
		<th width="12%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.cardnumber!}</th>
		<th width="10%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.salary1!}</th>
		...
		<th width="9%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.salary4!}</th>
		<th width="9%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.salary5!}</th>
		<th width="10%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.salary6!}</th>
		<th width="10%" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.salary7!}</th>
		...
		<th width="80px" style="word-break:break-all; word-wrap:break-word;">${officeSalaryImport.realname!}</th>
		...
		<th class="t-center" width="60px" style="word-break:break-all; word-wrap:break-word;"><a href="javascript:doEdit2('${officeSalaryImport.id!}');"><img src="${request.contextPath}/static/images/icon/edit.png" alt="编辑"></a></th>
	</tr>
	</#if>
	<#if officeSalaryList?exists && (officeSalaryList?size>0)>
		<#list officeSalaryList as officeSalary>
		    <tr>
				...
				<td class="t-center">
						<a href="javascript:doEdit('${officeSalary.id!}');"><img src="${request.contextPath}/static/images/icon/edit.png" alt="编辑"></a>&nbsp;&nbsp;
						<a href="javascript:doDelete('${officeSalary.id!}');"><img src="${request.contextPath}/static/images/icon/del2.png" alt="删除">
				</td>
			</tr>
		</#list>
	<#else>
