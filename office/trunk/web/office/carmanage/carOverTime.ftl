...
function doSearch(){
	...
	var url="${request.contextPath}/office/carmanage/carmanage-carOverTimeList.action"+str;
...
function doExp(){
	...
	var str = "?queryStartTime="+queryStartTime+"&queryEndTime="+queryEndTime;
	location.href="${request.contextPath}/office/carmanage/carmanage-carOverTimeExport.action"+str;
}
	...
	<div class="pub-table-inner">
		<div class="query-builder-nobg mt-5" style="padding:0 0 5px 0;">  
    		<div class="query-part">
			    ...
			    <a href="javascript:void(0);" onclick="doExp();"   class="abtn-blue fn-right mr-10">统计导出</a>
			</div>
    	</div>
    </div>
</div>
<div id="carOverTimeListDiv"></div>
