...
function doSearch(){
	...
	load("#mySurveyListDiv", "${request.contextPath}/office/businesstrip/businessTrip-myBusinessTripList.action?states="+states);
}

function doBusinessTripAdd(){
	load("#mySurveyListDiv", "${request.contextPath}/office/businesstrip/businessTrip-myBusinessTripEdit.action");
}
