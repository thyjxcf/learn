...
function doEdit(id){
	...
	openDiv("#classLayer", "#classLayer .close,#classLayer .submit,#classLayer .reset", "${request.contextPath}/office/asset/assetAdmin-purchaseEdit.action?purchase.id="+id+"&stateQuery="+stateQuery, null, null, "500px");
}
...
<div class="query-builder-nobg mt-15" style="padding:0 0 5px 0;">
    <div class="query-part">
		...
		<@htmlmacro.select style="width:120px;" valName="stateQuery" valId="stateQuery" myfunchange="doSearch">
			...
			<a val="0"  <#if stateQuery?default("")=="0">class="selected"</#if>><span>未维护</span></a>
...
<form name="form1" action="" method="post">
	...
	<tr>
		<th width="9%" rowspan="2">请购单编号</th>
		<th width="9%" rowspan="2">类别</th>
		<th width="8%" rowspan="2">物品名称</th>
		<th width="5%" rowspan="2">数量</th>
		<th width="8%" rowspan="2">申请单价</th>
		<th width="11%" rowspan="2">实际采购单价</th>
		<th width="8%" rowspan="2">申请总价</th>
		<th width="11%" rowspan="2">实际采购总价</th>
		<th width="14%" colspan="2" class="t-center">采购人</th>
		<th width="8%" rowspan="2">采购批准</th>
		<th class="t-center" width="9%" rowspan="2">操作</th>
	</tr>
	<tr>
		<th width="8%">甲</th>
		<th width="9%">乙（请购人）</th>
	...
	<#if purchaseList?exists && (purchaseList?size>0)>
		<#list purchaseList as ent>
		    <tr>
				...
				<td>${(ent.purchasePrice?string("0.00"))?if_exists}</td>
				<td>${(ent.totalUnitPrice?string("0.00"))?if_exists}</td>
				...
				<td class="t-center">
					<#if assetPurAuth?default(false) && ent.purchaseState?default("") =="0">
