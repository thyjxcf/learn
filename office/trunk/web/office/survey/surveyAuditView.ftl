...
<form id="viewform" action="" method="post">
    <table border="0" cellspacing="0" cellpadding="0" class="table-form">
	    ...
	    <tr>
	    	<@htmlmacro.tdt msgName="审核意见" class="text-area input-readonly fn-left" readonly="true" id="opinion" name="officeSurveyAudit.opinion" maxLength="500" colspan="3" style="width:470px;" value="${officeSurveyAudit.opinion!}" />
	    </tr>
    </table>
</form>    
</div>
