...
function sear(){
	...
	var url="${request.contextPath}/office/executiveMeet/executiveMeet-minutesManageList.action?queryName="+queryName+"&startTime="+startTime+"&endTime="+endTime;
	load("#minutesManageListDiv", url);
}
</script>
...
<div id="minutesManageListDiv"></div>
<script>
