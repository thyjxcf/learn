...
public class Constants {
	...
	/**h5页面预校验返回结果类型 校验不通过*/
	public static final int MOBILE_VALIDATE_TYPE_FAILURE = -1;
	/**h5页面预校验返回结果类型 校验通过*/
	public static final int MOBILE_VALIDATE_TYPE_PASS = 1;
 ...
 // 操作类型
	...
	public static final String  DEPT_TOP_ID="00000000000000000000000000000000";
	
	public static final long intId=70514;//办公流程model id
	public static final long LEAVE_MOD_ID=01;//请假log   modid
	public static final long GO_OUT_MOD_ID=02;//外出log modid
	public static final long REPORT_MOD_ID=11;//工作汇报log  modid
	public static final long Jt_GOOUT_MOD_ID=70038;//外出mod id
	public static final long BUSSINESS_MOD_ID=70525;//出差
	
	public static final String FILE_INIID="SYSTEM.SMARTUPLOAD.MAXFILESIZE";//附件参数
	
	public static final String LOG_APPLY="LOG_APPLY";//申请操作
	public static final String LOG_AUDIT="LOG_AUDIT";//审核操作
	public static final String LOG_WEEK="LOG_WEEK";//周报
	public static final String LOG_MONTH="LOG_MONTH";//月报
    ...
    //附件上传类型
    public static final String FILE_CONTENT="uploadContentFile";
    public static final String FILE_ATTACHMENT = "uploadAttFile";
    
    //出差附件类型
    public static final String OFFICE_BUSINESS_TRIP_ATT="OFFICE_BUSINESS_TRIP_ATT";
    //集体外出附件类型
    public static final String OFFICE_JTGO_OUT_ATT="OFFICE_JTGO_OUT_ATT";
    //报修附件类型
    ...
    //工作日志附件类型
    public static final String OFFICE_SCHEDULE_AIT="OFFICE_SCHEDULE_AIT";
    //局长信箱附件类型
    public static final String OFFICE_JZMAIL_AIT="OFFICE_JZMAIL_AIT";
    //用印管理附件类型
    public static final String OFFICE_SEAL_AIT="OFFICE_SEAL_AIT";
