...
public class OfficeBulletinReadDaoImpl extends BaseDao<OfficeBulletinRead> implements OfficeBulletinReadDao{
	...
	public OfficeBulletinRead getOfficeBulletinReadByUnitIdAndBulletinId(
		...
		String sql = "select * from office_bulletin_read where unit_id = ? and bulletin_id=? and user_id=?";
		return query(sql, new Object[]{unitId,bulletinId,userId}, new SingleRow());
	}
