 ...
 * 
 */
public class OfficeBulletinXj implements Serializable{
	...
	private String tempCommentId;//模板id
	private String tempCommentName;//模板名称
	
	private String messageNumber;//文号
	...
	public String getTempCommentName() {
		return tempCommentName;
	}
	public void setTempCommentName(String tempCommentName) {
		this.tempCommentName = tempCommentName;
	}
