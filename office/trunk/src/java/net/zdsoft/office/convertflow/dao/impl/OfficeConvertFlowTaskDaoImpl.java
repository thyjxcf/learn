...
public class OfficeConvertFlowTaskDaoImpl extends BaseDao<OfficeConvertFlowTask> implements OfficeConvertFlowTaskDao{
	...
	private static final String QUERY_SQL_BY_CONVERT_FLOW_ID = "select * from office_convert_flow_task where convert_flow_id = ?";
	...
	public List<OfficeConvertFlowTask> getListByCfId(String convertFlowId){
		return query(QUERY_SQL_BY_CONVERT_FLOW_ID, convertFlowId, new MultiRow());
	}
	...
	public OfficeConvertFlowTask getConvertFlowByTaskId(String taskId){
		String sql = "select * from office_convert_flow_task where parm = ?";
		return query(sql, taskId, new SingleRow()); 
	}
	
	@Override
	public int delete(String convertFlowId, String[] taskIds){
		String sql = "delete from office_convert_flow_task where convert_flow_id = ? and parm in ";
		return updateForInSQL(sql, new Object[]{convertFlowId}, taskIds);
	}
}