...
public interface OfficeTeacherLeaveDao {
	...
	public List<OfficeTeacherLeave> getOfficeTeacherLeaveListByFlowIds(String[] flowIds,Pagination page);
	...
	public List<OfficeTeacherLeave> getOfficeTeacherLeavesByUnitIdAndUserId(String unitId,String userId,Date date);
}
