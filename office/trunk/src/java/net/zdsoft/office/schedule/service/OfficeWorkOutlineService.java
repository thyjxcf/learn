...
public interface OfficeWorkOutlineService{
	...
	public OfficeWorkOutline save(OfficeWorkOutline officeWorkOutline, UploadFile uploadFile);
	...
	public Integer update(OfficeWorkOutline officeWorkOutline, UploadFile uploadFile);
