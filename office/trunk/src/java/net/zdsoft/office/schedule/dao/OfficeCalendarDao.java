...
public interface OfficeCalendarDao{
	...
	public List<OfficeCalendar> getCalendarListByConditions(String unitId, String[] userIds, String creatorType, String startTime, String endTime, Pagination page);
}