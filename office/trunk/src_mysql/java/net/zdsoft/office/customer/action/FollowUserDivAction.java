...
public class FollowUserDivAction extends ObjectDivAction<User>{
	...
	public FollowUserDivAction() {
		setShowLetterIndex(true);
	}
	
	@Override
	protected List<User> getDatasByUnitId() {
		return officeCustomerApplyService.getFollowUserList(getLoginUser().getUnitId(), getLoginUser().getUserId());
	}
