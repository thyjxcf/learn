...
public class OfficeWorkArrangeContentDaoImpl extends BaseDao<OfficeWorkArrangeContent> implements OfficeWorkArrangeContentDao{
	...
	private static final String SQL_INSERT = "insert into office_work_arrange_content(id, outline_id, detail_id, work_date, content, dept_ids, place, state, work_start_time, work_End_time, attendees) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public OfficeWorkArrangeContent save(OfficeWorkArrangeContent officeWorkArrangeContent){
		...
		Object[] args = new Object[]{
			...
			officeWorkArrangeContent.getContent(), officeWorkArrangeContent.getDeptIds(), 
	...
	public Integer update(OfficeWorkArrangeContent officeWorkArrangeContent){
		String sql = "update office_work_arrange_content set work_date = ?, content = ?, dept_ids = ?, place = ?, work_start_time = ?, work_end_time = ?, attendees = ? where id = ? ";
		Object[] args = new Object[]{
			officeWorkArrangeContent.getWorkDate(), officeWorkArrangeContent.getContent(), 
