...
public class OfficeTeacherLeaveNhServiceImpl implements OfficeTeacherLeaveNhService{
	...
	public void startFlow(OfficeTeacherLeaveNh officeTeacherLeaveNh,
		...
		officeTeacherLeaveNh.setFlowId(processHandlerService.startProcessInstance(FlowConstant.OFFICE_SUBSYSTEM,officeTeacherLeaveNh.getFlowId(), Integer.parseInt(FlowConstant.OFFICE_SUBSYSTEM+officeTeacherLeaveNh.getFlowType()), officeTeacherLeaveNh.getId(), userId, variables));
		update(officeTeacherLeaveNh);
	}
	...
	public OfficeTeacherLeaveNh getOfficeTeacherLeaveNhById(String id){
		...
		if(StringUtils.isNotEmpty(officeTeacherLeaveNh.getFlowId())){
			officeTeacherLeaveNh.setHisTaskList(getHisTisk(officeTeacherLeaveNh.getFlowId()));
		}
