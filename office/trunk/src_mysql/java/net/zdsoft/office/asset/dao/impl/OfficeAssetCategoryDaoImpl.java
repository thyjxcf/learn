...
public class OfficeAssetCategoryDaoImpl extends BaseDao<OfficeAssetCategory> implements OfficeAssetCategoryDao{
	...
	private static final String SQL_INSERT = "insert into office_asset_category(id, unit_id, asset_name, leader_id, is_deleted,dept_leader_id) values(?,?,?,?,?,?)";
	
	private static final String SQL_UPDATE = "update office_asset_category set unit_id = ?, asset_name = ?, leader_id = ?, is_deleted = ?, dept_leader_id=? where id = ?";
