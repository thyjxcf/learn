...
public class RemoteOfficeWorkReportAction extends OfficeJsonBaseAction{
	...
	private String id;
	private String dataType;//1--我发出的,2--我收到的
...
//			}
		...
		}else if((DATA_TYPE_2.equals(dataType))){
...
//		json.put("receiveUserId", ent.getReceiveUserId());
	...
	public void saveWorkReport(){
		...
		JSONObject json = new JSONObject();
		try {
			file = StorageFileUtils.handleFile(new String[] {}, 1 * 1024);
			officeWorkReportService.save(ent,file);
			json.put("result",1);
