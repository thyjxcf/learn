...
public class OfficeMsgReceivingDaoImpl extends BaseDao<OfficeMsgReceiving> implements OfficeMsgReceivingDao{
	...
	public void updateReadAll(String receiveUserId) {
		String sql = "update office_msg_receiving set is_read = 1 where receive_user_id = ? and is_deleted = 0 ";
		update(sql, receiveUserId);
	}
	
	@Override
	public void updateRead(String id) {
		String sql = "update office_msg_receiving set is_read = 1, read_time = sysdate where id = ? and is_read = 0 ";
		update(sql,id);
	}
	...
	public void updateStar(String id, Integer hasStar) {
		...
		update(sql, new Object[]{hasStar, id});
	}
	...
	public String[] getChangedReceivingUserIds(String time) {
		String sql = "select distinct receive_user_id from office_msg_receiving where send_time > str_to_date(?,'%Y-%m-%d %H:%i:%s') or read_time > str_to_date(?,'%Y-%m-%d %H:%i:%s')";
