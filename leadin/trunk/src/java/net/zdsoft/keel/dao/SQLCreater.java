/*
 * $Id: SQLCreater.java,v 1.12 2007/01/12 02:54:53 liangxiao Exp $
 ...
 * 
 * @author liangxiao
 * @version $Revision: 1.12 $, $Date: 2007/01/12 02:54:53 $
 */
public class SQLCreater {

    private StringBuffer sql = null;
    private List<Object> args = null;
    private List<Integer> argTypes = null;
    ...
    public static void main(String[] args) {
        SQLCreater creater = new SQLCreater("SELECT * FROM s_usercount", false);
        creater.and("c_schid LIKE ?", "110001%", true);
        creater.and("c_username LIKE ?", "大牛", true);
        creater
                .andIn("id", new String[] { "1", "2", "3" }, Types.VARCHAR,
                        true);
        creater.or("c_password = ?", "大牛", true);
        creater.orderBy("c_schid");
        creater.orderByDesc("c_username");
        System.out.println(creater.getSQL());
        Object[] params = creater.getArgs();
