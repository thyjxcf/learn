/* 
 * @(#)SpellUtils.java    Created on 2005-8-30
 * Copyright (c) 2005 ZDSoft.net, Inc. All rights reserved.
 * $Header: /project/keel/src/net/zdsoft/keel/util/SpellUtils.java,v 1.11 2007/12/14 09:52:50 huangwj Exp $
 */
 ...
 * 
 * @author liangxiao
 * @version $Revision: 1.11 $, $Date: 2007/12/14 09:52:50 $
 */
public class SpellUtils {

    private static LinkedHashMap<String, Integer> spellMap = new LinkedHashMap<String, Integer>(400);;

    public static HashMap<String, String> surnameMap = new HashMap<String, String>(415);
    ...
    public static String getFirstSpell(String cnStr) {
        ...
        for (int i = 0; i < cnStr.length(); i++) {
            stringBuffer.append(getFirstSpell(cnStr.charAt(i)));
        }
    ...
    public static String getAbbreviateSpell(String cnStr) {
        ...
        for (int i = 0; i < cnStr.length(); i++) {
            if (i == 0) {
                stringBuffer.append(getFullSpell(cnStr.charAt(i)));
            }
            else {
                stringBuffer.append(getFirstSpell(cnStr.charAt(i)));
            }
    ...
    public static String getSurnameFirstSpell(String cnName) {
        ...
        String surnameFirstSpell = (String) surnameMap.get(cnName.substring(0,
                1));
    ...
    public static void main(String[] args) {
        String[] array = getSurnameFirstSpellRange(new String[] { "陈方娟", "陈丽伟",
                "陈美珍", "陈晓萍", "陈又森", "崔张龙", "樊利庆", "范广彬", "方彩珠", "高幼莉", "顾华萍",
                "顾华萍", "韩宝灿", "胡斌彬", "胡斌彬", "姜兰兰", "金建月", "金霞", "克瑞斯", "李建英",
                "李菊根", "林春蕾", "林亦敏", "罗才军", "孟海英", "倪金萍", "潘丽萍", "潘卫燕", "戚文葱",
                "钱金金", "汤红霞", "汤红霞", "王飞  ", "王清美", "谢芳  ", "谢黎霞", "谢灵珍", "徐军",
                "徐军萍", "徐黎明", "徐莉萍", "徐如珍", "许月娣", "宣国成", "薛燕燕", "学校信息中心",
                "杨红美", "叶飞  ", "叶丽华", "叶柱  ", "叶柱  ", "余锦霞", "章宝土", "章波  ",
                "郑百苗", "郑淑华", "钟惠芬", "周海英", "周鹤龄", "周伟月", "朱飞英", "朱卫军", "朱意华",
                "朱张尧", "楮丽浓", "楼小峰", "牟强" });
