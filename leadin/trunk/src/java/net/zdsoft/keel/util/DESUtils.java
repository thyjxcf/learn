/* 
 * @(#)DESUtils.java    Created on 2008-6-5
 * Copyright (c) 2008 ZDSoft Networks, Inc. All rights reserved.
 * $Id: DESUtils.java,v 1.1 2008/06/05 11:00:40 huangwj Exp $
 */
 ...
 * 
 * @author huangwj
 * @version $Revision: 1.1 $, $Date: 2008/06/05 11:00:40 $
 */
public final class DESUtils {
     ...
     */
    public static String encrypt(String data, String firstKey,
     ...
     */
    public static String decrypt(String data, String firstKey,
            String secondKey, String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List<int[]> firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
