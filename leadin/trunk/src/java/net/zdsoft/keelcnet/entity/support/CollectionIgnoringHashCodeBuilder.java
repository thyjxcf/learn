...
/**
 * <p>Customized EqualsBuilder ignoring Collection fields.</p>
 *
 * <p>Only append(Object, Object) was modified</p>
 */
public class CollectionIgnoringHashCodeBuilder extends HashCodeBuilder {
    private static Logger log = LoggerFactory.getLogger(CollectionIgnoringHashCodeBuilder.class);
     ...
     */
    public CollectionIgnoringHashCodeBuilder(int initialNonZeroOddNumber,
    ...
    public static int reflectionHashCodeA(int initialNonZeroOddNumber,
        int multiplierNonZeroOddNumber, Object object, boolean testTransients,
        ...
        HashCodeBuilder builder = new CollectionIgnoringHashCodeBuilder(initialNonZeroOddNumber,
                ...
                if (!(object instanceof Collection) &&
                    ...
                    try {
                        ...
                        if (log.isDebugEnabled()) {
                            log.debug(
                                "Ignored field in hashCode method due to exception: " +
