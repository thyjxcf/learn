 ...
 *
 */
public class CollectionIgnoringEqualsBuilder extends EqualsBuilder {
    private static Logger log = LoggerFactory.getLogger(CollectionIgnoringEqualsBuilder.class);
    ...
    /**
     * <p>Constructor for CollectionIgnoringEqualsBuilder.</p>
     *
     ...
     * @since 2.0
     */
    public static boolean reflectionEqualsB(Object lhs, Object rhs,
        ...
        CollectionIgnoringEqualsBuilder equalsBuilder = new CollectionIgnoringEqualsBuilder();
    ...
    private static void reflectionAppend(Object lhs, Object rhs, Class<?> clazz,
        CollectionIgnoringEqualsBuilder builder, boolean useTransients) {
     ...
     * <code>equals</code> method, ignoring collections.</p>
     *
     * @param lhs  the left hand object
     * @param rhs  the right hand object
     * @return EqualsBuilder - used to chain calls.
    ...
    public EqualsBuilder append(Object lhs, Object rhs) {
        ...
        /*****************************************************/
        if ((lhs instanceof Collection) || (lhs instanceof Map) ||
                (lhs == null)) {
            if ((rhs instanceof Collection) || (rhs instanceof Map) ||
                    (rhs == null)) {
                return this;
            }
        }
        ...
        if ((lhs == null) || (rhs == null)) {
            ...
            if (log.isInfoEnabled()) {
                log.info("Equals failed: " + lhs + " is not equal to " + rhs);
            }
        ...
        if (!lhsClass.isArray()) {
            ...
            if (!b && log.isInfoEnabled()) {
                log.info("Equals failed: [" + lhs.getClass().getName() + "] " +
                    lhs + " is not equal to [" + rhs.getClass().getName() +
                    "] " + rhs);
            }
