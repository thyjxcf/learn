...
function submitForm(){
	...
	auditForm.action="unitAdmin-saveAudit.action";
  ...
  <tr>
  	<td>
  	  <table height="100%" width="100%" cellspacing="0" cellpadding="0" border="0">
  	  	<tr>
  	  	  <td style="color:#29248A" width="120px" class="send_font_title">单位审核</td>
  	  	  <td width="50%">
  	  	  	<div id="testdiv" style="display:none;"></div>
  	  	  </td>
  	  	  <td align="right" width="350px" style="padding-right:5px;">
  	  	  	<span class="comm_button21" onMouseover = "this.className = 'comm_button21';" onMousedown= "this.className = 'comm_button22';"onMouseout= "this.className = 'comm_button21';" onClick="audit();">审核</span>
  	  	  	<span class="comm_button21" onMouseover = "this.className = 'comm_button21';" onMousedown= "this.className = 'comm_button22';"onMouseout= "this.className = 'comm_button21';" onClick="lock();">锁定</span>
