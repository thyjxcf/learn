...
public class AttachmentDaoImpl extends BaseDao<Attachment> implements AttachmentDao {
    ...
    private static final String SQL_FIND_ATTACHMENTS_BY_OBJECTID_OBJECTTYPE = "SELECT * FROM sys_attachment WHERE obj_id=? AND objecttype=? order by modify_time desc";
    ...
    public Attachment setField(ResultSet rs) throws SQLException {
        ...
        attachment.setCreationTime(rs.getTimestamp("creation_time"));
        attachment.setModifyTime(rs.getTimestamp("modify_time"));
