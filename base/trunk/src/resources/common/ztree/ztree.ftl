...
<div class="search"><input type="text" class="txt"  id="searchForName" placeholder="${searchTips?default('输入搜索值')}"><#if '${useCheckbox!}' =='true'><span style="font-size: 12px">&nbsp;&nbsp;是否级联:</span><input type="checkbox" id="cascade" class="checkbox first"  /></#if></div>
