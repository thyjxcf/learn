/* 
 * @(#)EisuClassService.java    Created on May 14, 2011
...
/**
 * @author zhaosf
 * @version $Revision: 1.0 $, $Date: May 14, 2011 12:57:59 PM $
 */
public interface EisuClassService extends AbstractClassService<EisuClass> {
	/**
	 * 更新班级毕业状态
	 * 
	 * @param classId
	...
	/**
	 * 根据树上节点的type,取得其下的班级列表
	 * 
	 * @param id
	 * @param type
	 * @param specId当年级节点是使用
	 * @param pointId当年级节点是使用
	 * @return
	 */
