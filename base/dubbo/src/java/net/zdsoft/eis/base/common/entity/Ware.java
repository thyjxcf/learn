...
public class Ware extends BaseEntity {
	...
	public static List<Ware> dt(String data) {
		List<Ware> ts = SUtils.dt(data, new TypeReference<List<Ware>>() {
		});
		if (ts == null)
			ts = new ArrayList<Ware>();
		return ts;

	}

	public static Ware dc(String data) {
		return SUtils.dc(data, Ware.class);
	}
