...
public class CodeRuleBuildDaoImpl extends BaseDao<CodeRuleDetail> implements CodeRuleBuildDao {
    ...
    private Logger log = Logger.getLogger(CodeRuleBuildDaoImpl.class);
	
	@Autowired
	private CodeRuleRemoteService codeRuleRemoteService;
	
	@Autowired
	private CodeRuleDetailRemoteService codeRuleDetailRemoteService;
    ...
    public CodeRule getCodeRule(String section, int type) {
    	...
    	return CodeRule.dc(codeRuleRemoteService.findBySectionCodeType(section,type));
...
//                });
    ...
    public List<CodeRule> getCodeRules(int type) {
    	...
    	return CodeRule.dt(codeRuleRemoteService.findByCodeType(type));
...
//                });
    ...
    public CodeRule getUnitCodeRule(String schoolId, int codeType) {
    	return CodeRule.dc(codeRuleRemoteService.findByUnitIdCodeType(schoolId,codeType));
...
//                });
    ...
    public List<CodeRuleDetail> getCodeRuleDetails(String ruleId) {
    	...
    	return CodeRuleDetail.dt(codeRuleDetailRemoteService.findByRuleId(ruleId));
