...
public class EduInfo extends BaseEntity {
	...
	public static List<EduInfo> dt(String data) {
		List<EduInfo> ts = SUtils.dt(data, new TypeReference<List<EduInfo>>() {
		});
		if (ts == null)
			ts = new ArrayList<EduInfo>();
		return ts;

	}

	public static List<EduInfo> dt(String data, Pagination page) {
		JSONObject json = JSONObject.parseObject(data);
		List<EduInfo> ts = SUtils.dt(json.getString("data"), new TypeReference<List<EduInfo>>() {
		});
		if (ts == null)
			ts = new ArrayList<EduInfo>();
	...
	public static EduInfo dc(String data) {
		return SUtils.dc(data, EduInfo.class);
	}
