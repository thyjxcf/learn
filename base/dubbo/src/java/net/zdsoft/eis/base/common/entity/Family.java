...
public class Family extends BaseEntity {
	...
	public static Family dc(String data) {
		return SUtils.dc(data, Family.class);
	}
	
	public static List<Family> dt(String data) {
		List<Family> ts = SUtils.dt(data, new TypeReference<List<Family>>() {
		});
		if (ts == null)
			ts = new ArrayList<Family>();
		return ts;
