...
public class OrderDaoImpl extends BaseDao<Order> implements OrderDao {
    ...
    public List<Order> getOrderListByUser(String userId) {
        ...
        return Order.dt(orderRemoteService.findByCustomerId(userId,1,formattedTime,formattedTime));
    ...
    public List<Order> getOrderListByUnit(String unitId) {
        String formattedTime = DateUtils.date2StringByDay(new Date());
        return Order.dt(orderRemoteService.findByCustomerId(unitId,0,formattedTime,formattedTime));
    ...
    public List<Order> getServiceOrder(int serverId, String... customerIds) {
    	return Order.dt(orderRemoteService.findByServer(serverId,customerIds));
    	/*SELECT * FROM base_order WHERE is_deleted=0 AND server_id=? AND customer_id IN 
