<div class="more-list" style="height:${height?default(370)-30}px;">
	<ul>
...
<p class="more-btn">
	<span class="fn-left mt-5 ml-15"><input type="checkbox" class="chk" id="checkAllInput">全选</span>
	<a href="javascript:void(0);" class="moreSubmit" onclick="closeInnerMore();">关闭</a>
</p>
<script>
