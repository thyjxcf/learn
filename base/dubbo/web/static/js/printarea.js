...
(function ($) {
    ...
    function getHead() {
        ...
        head += "<style>.noprint{display:none;}table{font-size:12px;}</style></head>";
        return head;
    }
    ...
    function Popup() {
        ...
        windowAttr += ",width=" + settings.popWd + "px,height=" + settings.popHt + "px,top=0,left=0,toolbar=no,scrollbars=no,personalbar=no";
