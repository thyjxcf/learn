...
function printIntensity(rank) {
	if (rank == 1) {
		document.getElementById("safetyRange").className ="acc-safety acc-safety-low fn-left";
	} else if (rank == 2) {
		document.getElementById("safetyRange").className ="acc-safety acc-safety-center fn-left";
	} else if (rank == 3) {
		document.getElementById("safetyRange").className ="acc-safety acc-safety-high fn-left";
	}
}
